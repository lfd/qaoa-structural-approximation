...
\begin{tikzpicture}
    ...
    \node[matrix, ibox, anchor=north west] (instance3) at (5.5,0) {
        \randellipse{1.5em}{0.75em}{20} &&
        \randellipse{1em}{1em}{120} \\
        & \randellipse{0.75em}{1em}{50} &\\
    };

    \node[matrix, ibox, anchor=north] (instance2) at ($(instance1.north)!0.5!(instance3.north)$) {
    ...
    \node[matrix, ibox, anchor=north] (global) at ($(instance2.north) + (0,-3)$) {
    ...
    \node[ibox, anchor=north] (avginf) at ($(global.north) + (0,-3)$) {};
    \lscapeimg{avginf}{4}
    ...
    \node[ibox, anchor=north west] (landscape3) at ($(-8.5,0) - (1em,0)$) { };    
    \binimg{landscape3}{3}
    \node[anchor=south west] at (landscape3.south west) {\(\bm{c^{(1)}(\vec{z})}\)};

    \node[ibox, anchor=north] (landscape2) at ($(landscape3.north)!0.5!(landscape1.north)$) { };
    \binimg{landscape2}{2}
    ...
    \node[ibox, anchor=north west] (qaoa3) at ($(-8.5,-3) - (1em,0)$) { };    
    \lscapeimg{qaoa3}{3}
    \flabel{3}{1}

    \node[ibox, anchor=north] (qaoa2) at ($(qaoa1.north)!0.5!(qaoa3.north)$) { };
    \lscapeimg{qaoa2}{2}
    \flabel{2}{2}
    ...
    % draw reference line for \textwidth
    %\draw[red,dashed] (landscape3.west) -- +(\textwidth,0);

    \node[ibox, anchor=north] (avglscape) at ($(qaoa2.north) + (0,-3)$) { };
